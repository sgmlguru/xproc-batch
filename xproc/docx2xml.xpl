...
<p:declare-step
    ...
    <p:option name="include-filter" select="'(docx|DOCX)'">
        <p:documentation>
    ...
    <p:option name="extract-docx" select="'true'"/>
    ...
    <p:import href="http://www.sgmlguru/ns/xproc/steps/extract-from-docx.xpl"/>
    ...
    <p:choose name="extract-archive">
        <p:when test="$extract-docx = 'true'">
            <!-- Extract from docx -->
            <sg:extract-from-docx name="extract">
