...
<p:declare-step
    ...
    xmlns:_x="http://www.w3.org/1999/XSL/TransformAlias"
    version="3.0">
    ...
    <p:input port="xspec2xsl">
        ...
        <!-- ../xspec/src/compiler/generate-xspec-tests.xsl -->
    </p:input>
    ...
    <p:choose name="run">
        <p:when test="$run-xspecs='true'">
            ...
            <p:identity message="{concat('Temp folder is ',$tmp-folder-uri)} {concat('XSpec manifest URI is ',$xspec-manifest-uri)}">
                <p:with-input>
                    <p:empty/>
                </p:with-input>
            </p:identity>
            ...
            <p:for-each name="generate-xslt-tests">
                ...
                <p:variable name="current-path" select="base-uri()"/>
                ...
                <p:xslt name="xspec2xsl" parameters="$params" version="2.0">
                ...
                <p:store serialization="map{'method': 'xml'}">
                    <p:with-option name="href" select="replace($current-path,'\.xspec','-report.xsl')"/>
                </p:store>
                
                <!-- Run the XSLT -->
                <p:xslt name="runxspec-xslt" parameters="$params" version="2.0" template-name="main">
                    <p:with-input port="source">
                        <p:empty/>
                    </p:with-input>
                    <p:with-input port="stylesheet">
                ...
                <p:xslt name="xspec-xml2html" parameters="$params" version="2.0">
                    <p:with-input port="source">
                        <p:empty/>
                    </p:with-input>
                    <p:with-input port="stylesheet">
